  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">AI智能助手平台</h1>
      </div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/travel-planner')">
        <div class="card-glow"></div>
        <div class="app-icon travel-icon">🗺️</div>
        <div class="app-info">
          <div class="app-title">知途AI出行规划</div>
          <div class="app-desc">智能出行规划助手，一键生成旅行方案</div>
        </div>
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'AI智能助手平台提供知途AI出行规划、AI超级智能体等服务，满足您的各种AI需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI出行规划,AI助手,智能对话,AI超级智能体'
    }
  ]
})
